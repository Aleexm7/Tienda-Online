...
@section('womanPantalones')

<div class="container">
    <div class="d-flex flex-row mt-4">
        <span class="p-2 ms-2"><a href="{{ route('womanSection')}}" class="nav-link-list">Volver</a></span>
        <span class="p-2 ms-2"><a href="{{ route('womanPantalones') }}" class="nav-link-list active">Largos</a></span>
        <span class="p-2 ms-2"><a href="{{ route('womanPantalonesCortos') }}" class="nav-link-list">Cortos</a></span>
    </div>
    <div class="row mt-4">
        @include('alerts.msg')
        ...
        <div class="col-md-4 mb-4">
            <form action="{{ route('add') }}" method="post">
                ...
                @php
                            ...
                            $imagePath = '/assets/img/products/woman/pantalones/pantalon' . ($loop->index + 1) . '.webp';
                        ...
                        @if (file_exists(public_path($imagePath)))
                            <img src="{{ asset($imagePath) }}" alt="pantalon">
