...
@section('menPantalonesVaqueros')
<div class="container">
    <div class="d-flex flex-row mt-2">
        <span class="p-2 ms-2"><a href="{{ route('menSection')}}" class="nav-link-list">Volver</a></span>
        <span class="p-2 ms-2"><a href="{{ route('menPantalones')}}" class="nav-link-list active">Vaqueros</a></span>
        ...
        <div class="col-md-4 mb-4">
            <form action="{{ route('add') }}" method="post">
                ...
                @php
                            ...
                            $imagePath = '/assets/img/products/men/pantalones/pantalonesVaquero' . ($loop->index + 1) . '.webp';
                        ...
                        @if (file_exists(public_path($imagePath)))
                            <img src="{{ asset($imagePath) }}" alt="pantalon vaquero">
                        @else (file_exists(public_path($newImagePath)))
                            <img src="{{ asset($newImagePath) }}" alt="pantalon nuevo">
                        @endif
                    <div class="card-body">
