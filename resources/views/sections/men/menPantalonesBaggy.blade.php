...
<div class="container">
    <div class="d-flex flex-row mt-2">
        ...
        <span class="p-2 ms-2"><a href="{{ route('menPantalonesBaggy')}}" class="nav-link-list active">Baggy</a></span>
        ...
        <div class="col-md-4 mb-4">
            <form action="{{ route('add') }}" method="post">
                ...
                @php
                            ...
                            $imagePath = '/assets/img/products/men/pantalones/pantalonesBaggy' . ($loop->index + 1) . '.webp';
                        ...
                        @if (file_exists(public_path($imagePath)))
                            <img src="{{ asset($imagePath) }}" alt="pantalon baggy">
                        @else (file_exists(public_path($newImagePath)))
                            <img src="{{ asset($newImagePath) }}" alt="pantalon baggy nuevo">
                        @endif
                    <div class="card-body">
