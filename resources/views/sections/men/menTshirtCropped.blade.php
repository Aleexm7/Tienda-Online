        ...
        <div class="col-md-4 mb-4">
            <form action="{{ route('add') }}" method="post">
                ...
                @php
                            ...
                            $imagePath = '/assets/img/products/men/camisetas/camisetasCropped' . ($loop->index + 1) . '.webp';
                        ...
                        @if (file_exists(public_path($imagePath)))
                            <img src="{{ asset($imagePath) }}" alt="camiseta cropped">
                        @else (file_exists(public_path($newImagePath)))
                            <img src="{{ asset($newImagePath) }}" alt="camiseta nueva">
                        @endif
                    <div class="card-body">
